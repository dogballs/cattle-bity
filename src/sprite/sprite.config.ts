const config = {
  ...
  powerupTank: ['sprite.png', 336, 112, 16, 15],
  ...
  'tank.gray.e.up.1': ['sprite.png', 129, 64, 13, 15],
  'tank.gray.e.up.2': ['sprite.png', 145, 64, 13, 15],
  'tank.gray.e.down.1': ['sprite.png', 193, 64, 13, 15],
  'tank.gray.e.down.2': ['sprite.png', 209, 64, 13, 15],
  'tank.gray.e.left.1': ['sprite.png', 160, 66, 15, 13],
  'tank.gray.e.left.2': ['sprite.png', 176, 66, 15, 13],
  'tank.gray.e.right.1': ['sprite.png', 225, 65, 15, 13],
  'tank.gray.e.right.2': ['sprite.png', 241, 65, 15, 13],

  'tank.gray.e.drop.up.1': ['sprite.png', 129, 192, 13, 15],
  'tank.gray.e.drop.up.2': ['sprite.png', 145, 192, 13, 15],
  'tank.gray.e.drop.down.1': ['sprite.png', 193, 192, 13, 15],
  'tank.gray.e.drop.down.2': ['sprite.png', 209, 192, 13, 15],
  'tank.gray.e.drop.left.1': ['sprite.png', 160, 194, 15, 13],
  'tank.gray.e.drop.left.2': ['sprite.png', 176, 194, 15, 13],
  'tank.gray.e.drop.right.1': ['sprite.png', 225, 193, 15, 13],
  'tank.gray.e.drop.right.2': ['sprite.png', 241, 193, 15, 13],

  'tank.yellow.a.down.1': ['sprite.png', 65, 1, 13, 13],
  'tank.yellow.a.down.2': ['sprite.png', 81, 1, 13, 13],
  'tank.yellow.a.left.1': ['sprite.png', 34, 1, 13, 13],
  'tank.yellow.a.left.2': ['sprite.png', 50, 1, 13, 13],
  'tank.yellow.a.right.1': ['sprite.png', 97, 1, 13, 13],
  'tank.yellow.a.right.2': ['sprite.png', 113, 1, 13, 13],
  'tank.yellow.a.up.1': ['sprite.png', 1, 2, 13, 13],
  'tank.yellow.a.up.2': ['sprite.png', 17, 2, 13, 13],
